...
module Application
  ...
  module Entities
    ...
    ## -----------------------------------------------------------------------------------
    class AuthorBase < Application::Entities::Mongoid
      expose :name
    end
    ## -----------------------------------------------------------------------------------
    ...
    ## -----------------------------------------------------------------------------------
    class AuthorEmbeds < Application::Entities::AuthorBase
      expose :_embedded do |record, options|
        ...
        unless options[:zoom].blank?
          ...
          embed_requests.each do |embed|
            case embed.to_sym
            when :books
              embeds[:books] = Application::Entities::BookBase.represent record.books
            end
          end
        end
        embeds
